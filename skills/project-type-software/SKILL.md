...
description: "Software development governance preset: adds worktree workflow rules, code quality standards, testing requirements, CI/CD patterns, and development-specific agent skills to the base OrqaStudio setup. Use when: The project being set up is a software development project."
user-invocable: true
---
