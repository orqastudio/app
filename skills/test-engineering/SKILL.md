...
description: "Test engineering methodology: test organisation, coverage requirements, mock boundaries, test writing standards, and the discipline of testing behavior not implementation. Portable across backend and frontend test frameworks. Use when: Writing tests, setting up test infrastructure, defining mock boundaries, or enforcing test coverage requirements."
user-invocable: true
---
