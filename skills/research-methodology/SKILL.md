...
description: "Research best practices for agents investigating external sources: source verification, credibility assessment, cross-referencing, and structured documentation of findings with confidence levels."
user-invocable: true
---
