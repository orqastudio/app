---
name: orqa-frontend-best-practices
description: "Umbrella skill for all frontend implementation work. Establishes composability, coding standards, and component conventions as always-in-mind principles, then references deeper skills for Svelte 5, TypeScript, and Tailwind specifics. Use when: Any agent is about to write or modify frontend code (ui/, components, stores)."
user-invocable: true
---
