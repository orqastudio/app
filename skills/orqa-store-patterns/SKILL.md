...
description: "OrqaStudio Svelte 5 rune store patterns: class-based stores with $state/$derived, store-to-component data flow, and reactive state management. Use when: Creating or modifying Svelte stores, wiring stores to components, managing loading/error/empty states, or debugging reactivity issues."
user-invocable: true
---
