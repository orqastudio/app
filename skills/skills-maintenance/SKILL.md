...
description: "Full skills.sh lifecycle management: CLI reference, skill evaluation criteria, SKILL.md format, portability rules, provenance tracking, and skill audit protocol. Use when: Adding, updating, removing, or auditing agent skills; evaluating whether to install a community skill or create a project-specific one; managing the .orqa/process/skills/ directory."
user-invocable: true
---
