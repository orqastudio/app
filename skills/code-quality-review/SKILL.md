...
description: "Code review methodology: automated checks, manual review checklists, forbidden pattern detection, function size limits, and structured review output format. Portable across any codebase with linting and testing infrastructure. Use when: Reviewing code for quality, running compliance checks, or producing structured review verdicts."
user-invocable: true
---
