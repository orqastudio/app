...
description: "End-to-end functional verification methodology: the \"Would It Work\" protocol, verification path tracing, persistence verification, common QA failure patterns, and structured QA report format. Use when: Verifying features work end-to-end, checking acceptance criteria, tracing data through system layers, or producing QA verdicts."
user-invocable: true
---
