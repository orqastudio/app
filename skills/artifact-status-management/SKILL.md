---
name: artifact-status-management
description: "Teaches agents when and how to correctly update artifact status fields. The unified status vocabulary has 11 values. Agents must update status to reflect the true state of thought — especially the review gate, which only humans may clear. Use when: Creating, updating, or completing any artifact during task execution."
...
- [AD-6cea0c64](AD-6cea0c64) — Icon-based status representation decision
- [DOC-94224b27](DOC-94224b27) — Status & Workflow user guide
