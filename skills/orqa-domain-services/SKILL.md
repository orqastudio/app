...
description: "OrqaStudio domain service patterns: how Rust backend services are structured, composed, tested, and wired to Tauri commands. Covers service anatomy, command delegation, error propagation, and the boundary between domain logic and framework code. Use when: Creating new domain services, refactoring backend logic out of commands, adding business logic to the Rust backend, or reviewing service architecture."
user-invocable: true
---
