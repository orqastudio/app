---
name: orqa-testing
description: "OrqaStudio testing patterns: make test commands, Rust unit/integration tests, Vitest frontend tests, mock boundaries, and test file organization. Use when: Writing tests, fixing test failures, setting up test infrastructure, or verifying test coverage."
user-invocable: true
---
