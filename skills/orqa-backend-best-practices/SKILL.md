---
name: orqa-backend-best-practices
description: "Umbrella skill for all backend implementation work. Establishes composability, coding standards, and error handling as always-in-mind principles, then references deeper skills for Rust, Tauri, and persistence specifics. Use when: Any agent is about to write or modify backend code (backend/src-tauri/, sidecar/)."
user-invocable: true
---
