---
name: uat-process
description: "Structured user acceptance testing methodology. Collect all findings first, group by systemic root cause, investigate architecture before proposing fixes, create tasks at the system level, and encode process improvements as lessons. Use when: Running UAT rounds, triaging user-reported issues, planning fix sprints."
