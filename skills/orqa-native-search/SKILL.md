...
description: "How to use Orqa's embedded search tools in the app context: tool names, query patterns, tool selection guide, and fallback behavior. Use when: Any agent needs to search code or artifacts from within the OrqaStudio app."
user-invocable: true
---
