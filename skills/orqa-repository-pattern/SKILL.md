...
description: "OrqaStudio's persistence layer using the repository pattern with rusqlite. Covers repository anatomy, connection management, query patterns, migrations, error handling, and testing. Use when: Adding a new database entity, writing a new repository module, modifying persistence logic, writing migration SQL, or testing database code."
user-invocable: true
---
