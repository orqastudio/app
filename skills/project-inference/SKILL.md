...
description: "Reads a project's folder structure and files to infer its characteristics: languages, frameworks, build tools, existing governance, and project type. Produces a structured project profile that drives setup decisions. Use when: Setting up OrqaStudio on an existing project, or detecting project characteristics for skill/rule selection."
user-invocable: true
---
