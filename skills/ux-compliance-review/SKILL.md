---
name: ux-compliance-review
description: "UX compliance review methodology: label auditing, state coverage verification, shared component usage checks, layout and accessibility auditing, and structured UX review output format. Use when: Reviewing UI implementations against specifications, auditing accessibility, checking design system compliance, or verifying state coverage."
user-invocable: true
---
