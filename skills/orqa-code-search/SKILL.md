---
name: orqa-code-search
description: "Context-aware code search wrapper. Detects whether you are in CLI (ChunkHound MCP) or App (native DuckDB+ONNX) context and provides the appropriate search patterns. Three tools: search_regex, search_semantic, code_research. Use when: Searching the codebase before creating new code, verifying endpoints exist, understanding how a system works, finding all callers before refactoring."
user-invocable: true
---
