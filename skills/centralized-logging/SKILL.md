...
description: "How to use the OrqaStudio centralized logging system. ALL code must use the SDK logger instead of bare console calls. Covers log levels, module scoping, error capture, perf instrumentation, and dev controller integration. Use when: writing any code that produces output, handles errors, or measures performance."
