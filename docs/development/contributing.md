...
- **Roadmap:** See `docs/product/roadmap.md` for the project direction. Features not on the roadmap should be discussed before implementation.
...
Documentation improvements are always welcome. The `docs/` directory is licensed under CC BY 4.0. See `docs/LICENSE` for terms.
