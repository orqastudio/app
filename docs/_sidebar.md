...
- **Product**
  ...
  - [User Journeys](/product/journeys)
  - [Information Architecture](/product/information-architecture)
  - [MVP Specification](/product/mvp-specification)

- **Architecture**
  - [Decisions](/architecture/decisions)
  - [SQLite Schema](/architecture/sqlite-schema)
  - [IPC Commands](/architecture/ipc-commands)
  - [Rust Modules](/architecture/rust-modules)
  - [Svelte Components](/architecture/svelte-components)
  - [Streaming Pipeline](/architecture/streaming-pipeline)
  - [Tool Definitions](/architecture/tool-definitions)
  - [MCP Host](/architecture/mcp-host)
...
- **Research**
  - [Overview](/research/)
  - [Claude Integration](/research/claude-integration)
  - [Tauri v2](/research/tauri-v2)
  - [Frontend](/research/frontend)
  - [Persistence](/research/persistence)
  - [Onboarding](/research/onboarding)
  - [Wireframing](/research/wireframing)
  - [Design Tokens](/research/design-tokens)
...
- **Process**
  ...
  - [Content Governance](/process/content-governance)
  - [Definition of Ready](/process/definition-of-ready)
  - [Definition of Done](/process/definition-of-done)
  - [Skills Log](/process/skills-log)
  - [Rules](/process/rules)
  - [Metrics](/process/metrics)
  - [Retrospectives](/process/retrospectives)
