...
Per [RULE-7f416d7d](RULE-7f416d7d), OrqaStudio delegates code quality enforcement to linters. Do NOT add file-based enforcement for patterns that clippy or ESLint already catch. Instead:
