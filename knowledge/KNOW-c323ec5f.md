...
### Detailed Reference Skills

For deep dives on specific topics, load these skills:
- `tauri-v2-capabilities-reference` — Permission patterns and examples
- `tauri-v2-ipc-patterns` — Complete IPC examples
