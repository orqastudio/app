...
- Check if any linter already covers it (see [RULE-7f416d7d](RULE-7f416d7d) — don't duplicate linter work)
...
- NEVER duplicate enforcement that linters already cover (see [RULE-7f416d7d](RULE-7f416d7d))
