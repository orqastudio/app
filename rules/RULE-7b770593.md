...
All artifact cross-references MUST use markdown link syntax: `[Display Text](ARTIFACT-ID)` where the artifact ID matches the standard format. The display text is typically the artifact ID itself: `[EPIC-e045ab6d](EPIC-e045ab6d)`.
