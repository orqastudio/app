...
The idea (IDEA-604e2651) proposes a fundamentally different model: instead of injecting knowledge AT agents, inject a **reasoning protocol** that teaches agents HOW to find knowledge themselves.
