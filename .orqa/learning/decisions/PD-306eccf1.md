...
- [PD-80f39962](PD-80f39962) — Core UI boundary (search is one of the three core capabilities)
- [PD-a47f313a](PD-a47f313a) — Schema-driven filtering (complements search with structured browsing)
- [PD-e8ea9fb9](PD-e8ea9fb9) — Config-driven navigation defaults (search and browsing serve different discovery needs)
