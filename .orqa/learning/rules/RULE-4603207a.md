...
| **Knowledge** | When capturing reusable domain knowledge that agents need to implement correctly | `.orqa/documentation/` |
| **Knowledge update** | When existing knowledge is incomplete or incorrect | Update existing knowledge in `.orqa/documentation/` |
