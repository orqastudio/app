...
- [RULE-0be7765e](RULE-0be7765e) (error-ownership) — *when* to verify (always, before every call)
- [RULE-eb269afb](RULE-eb269afb) (reusable-components) — *which* components to use (shared library)
- [RULE-8cb4bd04](RULE-8cb4bd04) (testing-standards) — testing patterns and coverage requirements
- [RULE-0d29fc91](RULE-0d29fc91) (code-search-usage) — use semantic search before creating new code
