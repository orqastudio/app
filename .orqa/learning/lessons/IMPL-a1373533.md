...
relationships:
  - type: cautions
    ...
    rationale: "Manual observation logging breaks under cognitive load — cautions knowledge maturity pipeline"
  - type: promoted-to
    target: RULE-c603e90e
    rationale: "Three-tier observation logging discipline promoted to lessons learned rule"
---
...
2. **Recurrence tracking is manual.** Even when a lesson exists (e.g., [IMPL-516733d4](IMPL-516733d4) about stale paths), the next agent that hits the same pattern doesn't search lessons and increment the count. The recurrence counter stays at 1 forever.
...
Three-tier logging discipline (user-approved via RES-fbe69e04):
...
Promoted — three-tier observation logging discipline (blocking/non-blocking/borderline) promoted to [RULE-c603e90e](RULE-c603e90e) update. Learning checkpoint at task completion encoded as process requirement.
