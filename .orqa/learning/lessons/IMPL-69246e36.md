...
relationships:
  - type: cautions
    ...
    rationale: "Epic titles should describe outcomes not process — cautions delivery pipeline"
---

## What Happened

During UAT Round 2 [EPIC-489c0a47](EPIC-489c0a47), epics were found with process-oriented titles like "UAT Round 1 — Dogfood Readiness Verification". The title describes the testing activity rather than the outcome being verified.
