...
relationships:
  - type: cautions
    ...
    rationale: "Stale-context conflicts when refactoring agent structure while delegating — cautions agent lifecycle"
---
...
Added to [RULE-998da8ea](RULE-998da8ea) (`dogfood-mode`) awareness. When `dogfood: true` and the work involves changing governance structure, the orchestrator must handle it directly.
