...
relationships:
  - type: cautions
    ...
    rationale: "Documentation must be app-native, not external tools — cautions doc reorganisation"
---
...
Documentation browsing is a first-class feature of OrqaStudio, not a bolted-on external tool. The artifact scanner reads markdown files directly, extracts frontmatter, and renders them in the app's artifact panel. This was formalized in [PD-f9fbd1d7](PD-f9fbd1d7) and [PD-45cfe1d1](PD-45cfe1d1).
