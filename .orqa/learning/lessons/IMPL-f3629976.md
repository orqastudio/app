...
relationships:
  - type: cautions
    ...
    rationale: "Idea promotion should surface related ideas for bundling — cautions discovery workflow"
---
...
Add a step to the idea promotion procedure in [RULE-b10fe6d1](RULE-b10fe6d1): before creating the epic, scan all ideas with `status: captured | exploring | shaped` for thematic overlap with the idea being promoted. Present any matches to the user and ask whether to:
