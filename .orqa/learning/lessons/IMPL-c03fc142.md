...
Currently [RULE-8abcbfd5](RULE-8abcbfd5) defines a fixed capability-to-tool mapping per provider. Claude Code CLI maps `file_read` → `Read` (native tool). But there's a choice the user should be able to make:
