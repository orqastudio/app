...
description: "When an artifact ID appears in body text (e.g., EPIC-7394ba2a referenced in a task description), there should be a corresponding relationship in the frontmatter. Body text references without graph edges are invisible to traversal."
status: captured
created: 2026-03-15
updated: 2026-03-15
...
relationships:
  - type: cautions
    ...
    rationale: "Body text refs without graph edges are invisible to traversal — cautions graph foundation"
---
