...
relationships:
  - type: cautions
    ...
    rationale: "Config path mismatches cause silent failures — cautions artifact system migration"
---
...
- Config said `.orqa/milestones/` — disk had `.orqa/implementation/milestones/`
...
This lesson was promoted to [RULE-63cc16ad](RULE-63cc16ad) (`artifact-config-integrity`), which enforces config-disk alignment and is part of the pre-commit verification checklist.
