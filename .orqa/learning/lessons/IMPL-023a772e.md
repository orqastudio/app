...
description: EPIC-c96c9f12 had both contains and delivered-by relationships for 38 task targets. These are the same relationship from different directions — only one should exist on each artifact.
status: archived
created: 2026-03-15
updated: 2026-03-15
...
relationships:
  - type: cautions
    ...
    rationale: "Duplicate relationship types on same artifact cautions the graph foundation epic"
---
