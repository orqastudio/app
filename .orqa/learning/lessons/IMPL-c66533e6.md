...
relationships:
  - type: cautions
    ...
    rationale: "Design discussions need structured mode with checkpoints — cautions discovery workflow"
---
...
1. Decisions were batched instead of presented one at a time (IMPL-d331eb1e)
2. No periodic zoom-out until user prompted (IMPL-79f34490)
3. Observations accumulated without automatic logging until user prompted (IMPL-a1373533)
