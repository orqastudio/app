...
relationships:
  - type: cautions
    ...
    rationale: "Stale paths left after directory reorg — cautions repository directory reorganisation"
---

## Pattern

When directory structure changes (e.g., `.orqa/governance/` → `.orqa/process/`, `.orqa/planning/` → `.orqa/implementation/`), the following get updated:
