...
**Audit scope:** `sidecar/src/`, `src-tauri/src/sidecar/`, streaming pipeline
...
**Audit scope:** `src-tauri/src/` — every module
...
**Audit scope:** `ui/lib/stores/` — all 10 stores
...
**Audit scope:** `ui/lib/components/` — every component
...
**Audit scope:** `ui/app.css`, `tailwind.config.ts`, `ui/lib/components/ui/`
...
**Audit scope:** `.orqa/project.json`, `src-tauri/capabilities/`, Makefile
