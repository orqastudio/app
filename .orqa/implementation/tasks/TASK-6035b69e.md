...
1. Add a `delivery` object to `project.json` with a `types` array. Example shape:
   ...
   "delivery": {
     "types": [
       { "key": "milestone", "label": "Milestone", "path": ".orqa/implementation/milestones", "parent": null },
       { "key": "epic",      "label": "Epic",      "path": ".orqa/implementation/epics",      "parent": "milestone" },
       { "key": "task",      "label": "Task",      "path": ".orqa/implementation/tasks",      "parent": "epic" }
     ]
   }
   ```
