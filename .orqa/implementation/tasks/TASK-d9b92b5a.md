...
acceptance:
  ...
  - "structure-before-code gate fires on code write without .orqa/implementation/ reads"
...
- **structure-before-code**: Fires on code write without `.orqa/implementation/` files

  being read. Injects structure prompt.

## How

1. Add gate logic checking WorkflowTracker for `.orqa/implementation/` reads
