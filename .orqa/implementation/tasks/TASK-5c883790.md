...
1. Determine active task from commit message or `.state/session-state.md`
...
- Stage an artifact that would fail [RULE-23699df2](RULE-23699df2) validation
- Commit with a message referencing a task that suspends [RULE-23699df2](RULE-23699df2) — commit succeeds with warning
