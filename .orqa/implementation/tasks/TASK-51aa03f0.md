...
- Project-level artifacts (`.orqa/implementation/`, `.orqa/principles/`, `.orqa/discovery/`) must use correct types and valid statuses
...
- `.orqa/implementation/` — project delivery artifacts (epics, tasks, milestones)
...
2. List all artifacts across `.orqa/implementation/`, `.orqa/discovery/`, `.orqa/principles/`
