...
2. For each entry: if it matches an artifact ID pattern (e.g., `[PD-7121ec20](PD-7121ec20)`), check if that artifact exists in the graph. If it is a file path, check if the file exists on disk.
