...
The orchestrator exception list says `.orqa/implementation/` is orchestrator territory, but writing research findings is content creation (Writer role). Tighten the boundary.
