...
acceptance:
  ...
  - DOC-f5bd63b4 (Dev Controller) is updated to reference the new port doc instead of hardcoding port 3001
  - DOC-8cf6ef38 (Dev Environment Setup) references the port doc for service configuration
...
5. **Cross-references** — links to DOC-f5bd63b4 (dev controller), DOC-d2c2063a (commands), DOC-8cf6ef38 (dev setup)

## Verification

1. `search_semantic` for "port allocation" or "service ports" finds this doc
2. DOC-f5bd63b4 references this doc for port 10401 instead of hardcoding 3001
3. The doc matches the actual port constants in code after TASK-35444c5b is complete
