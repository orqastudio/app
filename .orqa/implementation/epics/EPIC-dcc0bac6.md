...
# EPIC-dcc0bac6: Plugin infrastructure and delivery plugin extraction
...
- Plugin contributes status transition rules for its artifact types (from IDEA-617e3e69)
