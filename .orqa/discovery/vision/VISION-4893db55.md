  ...
  "artifacts": [
    ...
    { "key": "planning", "label": "Planning", "icon": "target",
      "children": [
        ...
        { "key": "milestones", "label": "Milestones", "path": ".orqa/implementation/milestones" }
      ]
    }
  ]
}
...
> **Source of truth:** Active pillars are defined as structured artifacts in `.orqa/principles/pillars/PILLAR-NNN.md`. The narrative below provides context; the pillar artifacts are authoritative for gate questions and conflict resolution.
...
The pillars are equal in importance. When they appear to conflict, the conflict is flagged to the user for resolution rather than one pillar automatically taking precedence. See the pillar artifacts in `.orqa/principles/pillars/` for authoritative conflict resolution guidance.
