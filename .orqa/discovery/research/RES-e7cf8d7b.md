...
| Roadmap doesn't reflect [MS-063c15b9](MS-063c15b9) | Completed work section has no milestone reference | References [MS-063c15b9](MS-063c15b9) and [EPIC-5a0624dc](EPIC-5a0624dc)–031 | Doc update |
...
**3c. Update [MS-b1ac0a20](MS-b1ac0a20) completed-epics count**

[MS-b1ac0a20](MS-b1ac0a20) has `completed-epics: 0` but [EPIC-797972a7](EPIC-797972a7) is done. Update to 1.
...
### WS-5: Viewer Infrastructure (Wave 2 — code, deferred to [EPIC-9ddef7f9](EPIC-9ddef7f9))
...
WS-4 (tracking epic)         ← Do alongside WS-1 so the work is tracked.
  ↓
WS-5 (viewers)               ← Separate epic (EPIC-9ddef7f9), runs after WS-1–3.
```
...
| Roadmap references [MS-063c15b9](MS-063c15b9) | Read roadmap, verify milestone and epic references |
| Migration tracked as epic | [EPIC-2f1efbd5](EPIC-2f1efbd5) exists with tasks |
