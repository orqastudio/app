...
relationships:
  - type: informs
    target: PD-d01b9e0a
    rationale: "Security hardening research informed the Tauri security model decision"
---
...
## Relationship to [PD-d01b9e0a](PD-d01b9e0a)

This hardening implements the security model described in [PD-d01b9e0a](PD-d01b9e0a) more strictly.
