...
7. Trace artifacts to affected systems (RULE-67b91c13)
...
1. **Update Orchestrator agent definition** (`.orqa/process/agents/AGENT-1dab5ebe.md`)
...
3. **Update existing rules for team context**
   - RULE-532100d9 (agent-delegation) — persistent teams vs disposable agents
   - RULE-00a8c660 (TeamCreate discipline) — team lifecycle
...
3. **Resource synchronization (enhance RULE-532100d9)**
