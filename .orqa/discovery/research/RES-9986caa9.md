...
| `epic-001-ai-transparency.md` | Already linked to [EPIC-797972a7](EPIC-797972a7) | No action needed |
...
**Key principle:** Wave 1 runs first and produces no code changes — only markdown files. It can be done in a single session. Wave 2 is [EPIC-9ddef7f9](EPIC-9ddef7f9) (Artifact Browser) from the roadmap, which is already a P2 dogfooding epic. Wave 3 is enhancement work.
...
| **[EPIC-f7f7fc0b](EPIC-f7f7fc0b)** (Documentation System) | Wave 3 cross-linking may overlap with this |
