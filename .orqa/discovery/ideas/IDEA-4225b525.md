...
research-needed:
  ...
  - "Depends on plugin architecture maturity (IDEA-7cbc3da3)"
relationships:
...
[AD-430829f1](AD-430829f1) notes that the structure and requirements for a tooling plugin (skill + hooks + data collection) are well-defined. During project initialization, if no existing plugin matches detected tooling, the system could offer to generate one. This is a natural extension of the plugin architecture once it matures.
