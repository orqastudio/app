...
OrqaStudio has a zero tech debt policy: no TODO comments, no commented-out code, no stubs, no deferred deliverables. This policy exists as rules (RULE-e9c54567, RULE-e120bb70) but enforcement is behavioral — agents are told not to create debt, but nothing mechanically prevents it.
...
- Already exists as RULE-e120bb70
