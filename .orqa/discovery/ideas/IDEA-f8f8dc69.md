...
The sync bridge built in EPIC-2f720d43 handles basic PR mirroring, but the contribution flow needs a clear decision:
...
- The management layer (IDEA-174fa5c8) would handle org-level auth configuration
