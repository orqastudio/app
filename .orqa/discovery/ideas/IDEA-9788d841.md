...
research-needed:
  ...
  - "How do UI tweaks (IDEA-a2b0dda6) fit — are they bugs, tasks, or their own thing?"
...
- **UI tweaks** (like [IDEA-a2b0dda6](IDEA-a2b0dda6)'s favicon/titlebar fixes) are similar — small, concrete, not part of a feature epic.
...
- `BUG-NNN` in `.orqa/implementation/bugs/`
