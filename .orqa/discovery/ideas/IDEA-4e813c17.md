...
research-needed:
  ...
  - "How does this relate to AD-e4a3b5da (Tool Implementation as MCP) and the existing plugin system ideas (IDEA-5113eeae)?"
...
relationships:
  ...
  - target: "PERSONA-477971bf"
    type: "benefits"
---
> **Surpassed 2026-03-16**: Plugin architecture concept merged into EPIC-dcc0bac6 via AD-ee2910b1. Runtime tool registration (WASM/MCP/script formats, capability-based permissions) split into IDEA-6669df10 as architecturally distinct from artifact/view plugins.
...
3. **Tool skills become tool documentation** — each plugin tool ships with its companion skill (IDEA-d2b8077d)
...
- Relates to [AD-e4a3b5da](AD-e4a3b5da) (MCP tools), [IDEA-5113eeae](IDEA-5113eeae) (plugin system), [IDEA-d2b8077d](IDEA-d2b8077d) (tool-linked skills)