...
OrqaStudio currently ships with Apache 2.0 which offers zero protection against big tech absorption. [RES-7e032412](RES-7e032412) investigated options and recommends **FSL (Functional Source License) + Trademark**.
...
This idea is shaped and ready for a decision (AD-NNN). The user should choose:
