...
description: "Build native observability into OrqaStudio rather than integrating AgentOps (architecture mismatch — see tmp/agentops-research.md). Track session metrics, delegation outcomes, cost awareness, and correlate analytics to artifacts."
status: captured
created: 2026-03-24
updated: 2026-03-24
horizon: later
...
- Stored in SQLite alongside existing session data (per AD-2aa4d6db)
