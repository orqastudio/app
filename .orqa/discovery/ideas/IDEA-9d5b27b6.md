...
research-needed:
  ...
  - "How does this interact with IDEA-1cbb9dc4 (unified logger)? The controller would be the log aggregation point."
relationships:
...
The combination with [IDEA-1cbb9dc4](IDEA-1cbb9dc4) (unified logger) is key: the logger produces structured events, the controller aggregates them. In dev mode it's automatic. In production mode the user opts in.
