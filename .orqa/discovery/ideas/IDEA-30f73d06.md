...
During [EPIC-88f359b0](EPIC-88f359b0), clicking save in the app UI overwrote a valid project.json with blank defaults — null description, empty artifacts array, empty frameworks. Required `git checkout` to recover. The pre-commit hook didn't catch this because it happened in-app, not through git.
