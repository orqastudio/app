...
updated: 2026-03-18
research-needed:
  - Can we run orqa enforce against registered plugins automatically on a schedule (CI)?
...
- **Compatibility CI** — scheduled runs of `orqa enforce` against registered plugins
