...
- Commit: "EPIC-056: Update documentation paths for directory reorganisation"
...
- Verify: `make clippy && make test-rust`
...
- Verify: `make check-frontend && make test-frontend`
...
| Phase | Check | Command |
|-------|-------|---------|
| 2 | Rust compiles with sidecar paths | `make clippy` |
| 3 | Cargo finds manifest | `cargo metadata --manifest-path backend/src-tauri/Cargo.toml` |
| 4 | Frontend checks pass | `make check-frontend && make test-frontend` |
