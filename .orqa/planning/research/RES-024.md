...
- **Sidecar self-edit warnings** — the sidecar they communicate through IS the sidecar they might be editing. Changes to `sidecars/orqa-sidecar/src/` require extra care: verify the change won't break the active connection, and warn the user before modifying protocol types
