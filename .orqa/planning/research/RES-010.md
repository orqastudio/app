...
status: draft
description: >
  Combined analysis of the seven universal agent roles, their task
  ownership boundaries, and how they map to Claude Code's fixed
  subagent types. Informs the agent restructuring from AD-029.
tags: [agents, roles, ownership, delegation, skills]
---
...
1. **Role portability** — Current agents are software-specific; need universal roles (AD-029)
...
| Manage artifact lifecycle (.orqa/) | Code changes (src-tauri/, ui/, sidecar/) |
...
- `.orqa/team/agents/orchestrator.md` — UPDATE existing
- `.orqa/team/agents/researcher.md` — NEW
- `.orqa/team/agents/planner.md` — NEW
- `.orqa/team/agents/implementer.md` — NEW
- `.orqa/team/agents/reviewer.md` — NEW
- `.orqa/team/agents/writer.md` — RENAME from documentation-writer.md
- `.orqa/team/agents/designer.md` — UPDATE existing
