...
### 1. New: `sidecars/orqa-sidecar/src/provider-interface.ts`
...
### 2. Refactor: `sidecars/orqa-sidecar/src/provider.ts` → `sidecars/orqa-sidecar/src/providers/claude-agent.ts`
...
The file `sidecars/orqa-sidecar/src/provider.ts` is replaced by a re-export facade so `index.ts`
changes are minimal in this phase.

### 3. New: `sidecars/orqa-sidecar/src/providers/index.ts`
...
### 4. Update: `sidecars/orqa-sidecar/src/index.ts`
...
- `sidecars/orqa-sidecar/src/protocol.ts` — `SendMessageRequest.sdk_session_id`, `SessionInitializedResponse.sdk_session_id`
- `sidecars/orqa-sidecar/src/providers/claude-agent.ts` — all internal references
...
### 6. Update: `sidecars/orqa-sidecar/src/protocol.ts`
...
| File | Action |
|------|--------|
| `sidecars/orqa-sidecar/src/provider-interface.ts` | NEW — Provider interface + types |
| `sidecars/orqa-sidecar/src/providers/claude-agent.ts` | NEW — ClaudeAgentProvider class (moved from provider.ts) |
| `sidecars/orqa-sidecar/src/providers/index.ts` | NEW — Provider factory |
| `sidecars/orqa-sidecar/src/provider.ts` | REPLACE — thin re-export facade from providers/ |
| `sidecars/orqa-sidecar/src/protocol.ts` | EDIT — rename sdk_session_id → provider_session_id |
| `sidecars/orqa-sidecar/src/index.ts` | EDIT — use provider instance instead of direct imports |
