...
created: 2026-03-07
updated: 2026-03-07
docs-required: [docs/wireframes/settings-onboarding.md, docs/architecture/setup-wizard.md]
docs-produced: [docs/wireframes/settings-onboarding.md (update with reviewed flows)]
depends-on: [EPIC-011]
blocks: []
scoring:
  pillar: 3
