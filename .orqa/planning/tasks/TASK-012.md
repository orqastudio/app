...
acceptance: [No Plan type definition in artifact-framework.md, Research schema added with draft/complete/surpassed workflow, Traceability chain updated to Task → Epic → Milestone]
---
