...
skills: [chunkhound, rust-async-patterns, tauri-v2]
scope: [src-tauri/src/search/store.rs, src-tauri/src/search/chunker.rs, src-tauri/src/search/types.rs, src-tauri/src/search/mod.rs, src-tauri/src/commands/search_commands.rs]
acceptance: [DuckDB database stores code chunks with file path, content, and metadata, Regex search finds patterns across indexed files, IPC command registered and callable from frontend]
---
