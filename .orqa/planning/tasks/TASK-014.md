...
scope: [src-tauri/src/search/embedder.rs, src-tauri/src/search/mod.rs, src-tauri/src/commands/search_commands.rs]
acceptance: [ONNX Runtime loads bge-small-en-v1.5 model, DirectML acceleration works (GPU/NPU with CPU fallback), Semantic search returns results ranked by cosine similarity]
---
