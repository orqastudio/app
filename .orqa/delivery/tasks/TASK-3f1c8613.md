...
Session management and overnight mode are currently conventions in orchestrator.md — writing session state to `.state/session-state.md`, committing work before stepping away, not continuing without user oversight. These should be a rule so they're enforceable and visible in the governance framework.
