...
1. `plugins/agile-workflow/` (DONE): The workflow-definition plugin. Owns the agile-methodology skeleton with contribution point slots.
...
- Read `plugins/agile-workflow/orqa-plugin.json` for current manifest structure
