...
- [AD-774cc3d0](AD-774cc3d0) has the concept taxonomy and decision framework
- [AD-6f0dea5e](AD-6f0dea5e) has the governance hub model, coexistence architecture, drift reconciliation
