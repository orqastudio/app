...
description: |
  Move the rule-enforcement SKILL.md from the plugin to .orqa/team/skills/ as a
...
symlinked to `.orqa/team/skills/rule-enforcement`. It should be a proper core skill
in `.orqa/team/skills/` with `layer: core`, since understanding enforcement is
...
1. Copy the rule-enforcement SKILL.md content to `.orqa/team/skills/rule-enforcement/SKILL.md` (replace symlink with real file)
...
- `.orqa/team/skills/rule-enforcement/SKILL.md` exists as a real file (not symlink)
