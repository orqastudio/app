...
Rewrite PipelineWidget.svelte algorithm to better model knowledge flow. Links to IDEA-c8b70949 for broader pipeline thinking. Focus on reducing false stuck/bottleneck indicators.