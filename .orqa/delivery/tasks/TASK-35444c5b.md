...
relationships:
  ...
  - target: TASK-72bb47b5
    type: depended-on-by
    rationale: "Auto-generated inverse of depends-on relationship from TASK-72bb47b5"
  - target: TASK-8aedd59b
    type: depended-on-by
    rationale: "Auto-generated inverse of depends-on relationship from TASK-8aedd59b"
...
- `app/backend/src-tauri/src/servers/lsp.rs:15` — hardcoded `3002` (see [TASK-ec4a3c53](TASK-ec4a3c53))
...
- `infrastructure/sync-bridge/src/config.ts:20` — defaults to `3001` (see [TASK-088e20b7](TASK-088e20b7))
