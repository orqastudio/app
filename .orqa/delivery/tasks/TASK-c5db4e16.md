...
acceptance:
  ...
  - All moved rules are accessible at runtime via the plugin hook injection mechanism (TASK-5bc61a09)
...
Blocked by TASK-5bc61a09 — the plugin hook injection mechanism must exist before this migration can happen cleanly.
...
3. Declare each rule in the owning plugin's manifest using the injection schema from TASK-5bc61a09
