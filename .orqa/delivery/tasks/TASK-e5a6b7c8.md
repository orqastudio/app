...
Verify the pre-commit hook (`.githooks/pre-commit`) is a reliable enforcement gate for all documented coding standards per RULE-57ccb4a3 (error-ownership) and RULE-7f416d7d (tooling-ecosystem).
