...
assignee: null
acceptance:
  - Prioritisation criteria from DOC-54594c57 surfaced in the artifact viewer when viewing epics/tasks
...
Priority assessment criteria live in `.orqa/documentation/about/priority-assessment.md` (DOC-54594c57). Currently, epics have an optional `scoring` field with freeform rationale, but this isn't enforced or surfaced prominently.
