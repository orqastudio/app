...
id: "TASK-9726f126"
type: task
title: "Create capability vocabulary rule (RULE-8abcbfd5)"
...
Create [RULE-8abcbfd5](RULE-8abcbfd5) that governs how agent capabilities map to provider-specific tools.
This is the foundation that [EPIC-9a1eba3f](EPIC-9a1eba3f) (companion plugin) and all future provider
...
- Rule file exists at `.orqa/process/rules/[RULE-8abcbfd5](RULE-8abcbfd5).md`
