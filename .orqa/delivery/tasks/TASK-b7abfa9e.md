...
Artifact IDs (e.g., TASK-2f67f14e, RES-d6e8ab11) use 8-character hex strings. These SHOULD be deterministic hashes of the artifact title, but this has not been consistently enforced. Some IDs were generated from arbitrary input strings, timestamps, or other non-title sources.
