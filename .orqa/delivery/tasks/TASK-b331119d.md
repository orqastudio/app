...
acceptance:
  ...
  - orqa validate passes on all 35 updated rule artifacts
...
1. Run `orqa validate` to get the full list of 35 non-compliant rules
...
4. Re-run `orqa validate` to confirm all 35 now pass

## Verification

1. `orqa validate` reports zero missing-enforcement violations
