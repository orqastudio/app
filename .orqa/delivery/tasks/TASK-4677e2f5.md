...
acceptance:
  ...
  - "RULE-af5771e3 updated to reference the hook"
relationships:
...
[RULE-af5771e3](RULE-af5771e3) (No Stubs) explicitly calls for a stub scanner as part of CI/quality checks. Currently there is no automated enforcement — agents self-police. Create a pre-commit hook that scans staged production files for TODO/FIXME/HACK comments and blocks the commit.

## How

1. Create a hook script that filters staged files to production code (exclude tests/, .state/)
...
5. Update [RULE-af5771e3](RULE-af5771e3) to reference the hook as enforcement mechanism
