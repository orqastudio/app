...
description: "Audit ui/src/lib/components/ for repeated patterns, create a component extraction skill, and update RULE-eb269afb enforcement to mandate component reuse as a composability requirement."
status: archived
created: "2026-03-11"
updated: "2026-03-11"
acceptance:
  ...
  - "RULE-eb269afb updated or companion rule created for enforcement"
  - "Follow-up tasks created for each shared component that should be extracted"
  - "Depends on TASK-f95678cd (component inventory) completing first"
relationships:
...
Component reuse is part of the composability principle (PILLAR-c9e0a695). Audit the entire frontend (`ui/src/lib/components/`) to identify repeated patterns that should be extracted into shared components.
...
- Update [RULE-eb269afb](RULE-eb269afb) or create a companion rule that enforces component reuse as a composability requirement
...
4. Edit [RULE-eb269afb](RULE-eb269afb) to add the search-before-creating mandate and FORBIDDEN section for known inline patterns
...
- [ ] Audit document listing all repeated patterns with occurrence counts
- [ ] New skill for component extraction methodology created
- [ ] [RULE-eb269afb](RULE-eb269afb) updated or companion rule created for enforcement
- [ ] Follow-up tasks created for each shared component that should be extracted
- [ ] Depends on [TASK-f95678cd](TASK-f95678cd) (component inventory) completing first
