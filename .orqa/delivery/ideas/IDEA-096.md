...
horizon: someday
research-needed:
  - "What interaction model works for pre-pipeline exploration? Canvas, mind-map, clustering?"
...
relationships:
  - type: informed-by
    target: PILLAR-001
    rationale: Making exploration visible and structured before it enters the delivery pipeline
  - type: informed-by
    target: PILLAR-003
...
Not yet defined — the interaction model needs research. Possibilities include freeform canvas, mind-map, card clustering, or a simpler grouped/tagged view.
