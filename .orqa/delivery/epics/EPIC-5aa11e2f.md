...
relationships:
  - target: "RES-94a3a6ca"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-94a3a6ca"
  - target: "RES-72f6f6b6"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-72f6f6b6"
  - target: "RES-b484fa9f"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-b484fa9f"
...
- [TASK-1637bc63](TASK-1637bc63): Audit all agent definitions for accuracy
- [TASK-d6030100](TASK-d6030100): Audit all skill definitions against codebase
- [TASK-88e72cc1](TASK-88e72cc1): Audit all rules for enforcement accuracy
- [TASK-81b11647](TASK-81b11647): Audit hooks for correctness
- [TASK-3109164e](TASK-3109164e): Cross-layer consistency verification
- [TASK-f2314ba0](TASK-f2314ba0): Create artifact audit skill
- [TASK-dfa29194](TASK-dfa29194): Audit for missing and miscategorised governance artifacts

## Out of Scope

- Rewriting skills from scratch (fix what's wrong, don't redesign)
- Adding new rules or skills (except the audit skill — TASK-f2314ba0)
