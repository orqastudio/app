...
- EPIC-dcc0bac6 Phase 2+: plugin discovery, runtime loading, enable/disable
- EPIC-2867fe9a Phase 3: schema-driven enforcement (so plugins can declare validation rules)
