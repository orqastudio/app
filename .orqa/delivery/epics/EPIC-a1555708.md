...
description: "Address critical code quality issues found by RES-6a16de02: eliminate stream_commands.rs
...
relationships:
  - target: "RES-6a16de02"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-6a16de02"
...
[RES-6a16de02](RES-6a16de02) audited the entire codebase (23k lines Rust, 15k lines Svelte/TS, 4k lines
...
| ID | Title |
|----|-------|
| [TASK-8a044656](TASK-8a044656) | Complete stream_commands.rs domain extraction |

### Phase 2: Test Coverage

| ID | Title |
|----|-------|
| [TASK-0d49089d](TASK-0d49089d) | Add frontend store unit tests (all 10 stores) |
| [TASK-f5b9530a](TASK-f5b9530a) | Add search module tests (embedder.rs + store.rs) |

### Phase 3: Error Handling

| ID | Title |
|----|-------|
| [TASK-38c7ea18](TASK-38c7ea18) | Add From<duckdb::Error> to OrqaError and fix search error propagation |
| [TASK-7c04e1d8](TASK-7c04e1d8) | Fix db.rs migration error handling (.unwrap_or patterns) |

### Phase 4: Cleanup

| ID | Title |
|----|-------|
| [TASK-cef272ad](TASK-cef272ad) | Audit backend-only commands — identify and remove orphaned code |
| [TASK-9e6bbff7](TASK-9e6bbff7) | Decompose AppState into grouped sub-structs |

### Phase 5: Dev Tooling

| ID | Title |
|----|-------|
| [TASK-36924b1c](TASK-36924b1c) | Unified dev logging — stream all info/error logs to OrqaDev Compose UI |
