...
relationships:
  - target: "RES-c46ece96"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-c46ece96"
...
**Bundled ideas**: [IDEA-c7da2e08](IDEA-c7da2e08), [IDEA-974623c0](IDEA-974623c0), [IDEA-d8a65eee](IDEA-d8a65eee), [IDEA-451b29b6](IDEA-451b29b6)

**Depends on**: [EPIC-a60f5b6b](EPIC-a60f5b6b) — prioritization and process enforcement must be in place first so this epic's priority is properly assessed and its process improvements are captured automatically.
...
| [TASK-6ec25d4b](TASK-6ec25d4b) | Native integrity checks in artifact_graph.rs | 1 | [TASK-25a42498](TASK-25a42498) |
| [TASK-9f888c45](TASK-9f888c45) | Auto-fix engine for deterministic integrity issues | 1 | [TASK-6ec25d4b](TASK-6ec25d4b) |
| ~~TASK-TBD-3~~ | ~~IPC commands~~ (merged into [TASK-6ec25d4b](TASK-6ec25d4b) + [TASK-9f888c45](TASK-9f888c45)) | — | — |
| [TASK-aa31fad6](TASK-aa31fad6) | Dashboard integrity widget — health score and issue list | 2 | [TASK-6ec25d4b](TASK-6ec25d4b) |
| [TASK-1648055e](TASK-1648055e) | Fix flow — auto-fix button and results display in IntegrityWidget | 2 | [TASK-aa31fad6](TASK-aa31fad6), [TASK-9f888c45](TASK-9f888c45) |
| [TASK-d9f83fb9](TASK-d9f83fb9) | Pipeline stage visualization widget | 3 | [TASK-25a42498](TASK-25a42498) |
| [TASK-ef349a65](TASK-ef349a65) | Graph health snapshot storage and trend sparklines | 4 | [TASK-6ec25d4b](TASK-6ec25d4b) |
| [TASK-22c9442a](TASK-22c9442a) | Integrity check: delivered ideas must have research-needed resolved | 1 | [TASK-6ec25d4b](TASK-6ec25d4b) |
| [TASK-8fa37f45](TASK-8fa37f45) | Audit integrity checking system for coverage gaps | 1 | [TASK-22c9442a](TASK-22c9442a) |
| [TASK-80c05aa7](TASK-80c05aa7) | Implement 7 high-priority integrity checks from audit | 1 | [TASK-8fa37f45](TASK-8fa37f45) |
| [TASK-c15165f5](TASK-c15165f5) | Reconcile [EPIC-82dd0bd2](EPIC-82dd0bd2) | — | all above |

## Out of Scope

- Replacing the Node-based CLI tools (they continue to work for CLI users)
- Full graph visualization (node-link diagram) — covered by [EPIC-d45b4dfd](EPIC-d45b4dfd)
- Plugin ecosystem for custom integrity checks (future)
- Notification system for integrity degradation (future idea)
- Process automation (related idea surfacing, observation capture) — moved to [EPIC-a60f5b6b](EPIC-a60f5b6b)