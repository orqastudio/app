...
**EPIC-8b01ee51 (Plugin Framework: Universal Capability Model) must be completed first.** The monorepo structure depends on:
...
|------|-------|-------------|--------|-----------|
| TASK-f036d514 | 1 | Test monorepo merge on throwaway clone | todo | — |
| TASK-7b011351 | 1 | Execute merge — import all 30 repos | todo | TASK-f036d514 |
| TASK-fe45b4f9 | 1 | Set up npm workspaces | todo | TASK-7b011351 |
| TASK-70118592 | 1 | Set up Cargo workspace | todo | TASK-7b011351 |
| TASK-a1ef2aad | 1 | Update orqa install pipeline | todo | TASK-fe45b4f9, TASK-70118592 |
| TASK-58a0bdf0 | 1 | License per directory + version management | todo | TASK-7b011351 |
| TASK-5fdbf116 | 1 | Verify full pipeline + archive original repos | todo | TASK-a1ef2aad, TASK-58a0bdf0 |
| TASK-499c51ea | 2 | Stand up Forgejo instance | todo | TASK-5fdbf116 |
| TASK-ab7001d9 | 3 | Migrate CI to Forgejo Actions | todo | TASK-499c51ea |
| TASK-687cae0e | 4 | Bidirectional contribution bridge | todo | TASK-ab7001d9 |
| TASK-001ad8c0 | 5 | Developer tooling (orqa git) | todo | TASK-687cae0e |
| TASK-3e657412 | — | Reconcile EPIC-2f720d43 | in-progress | all |
