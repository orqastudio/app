...
relationships:
  - target: "AD-c6c2d9fb"
    type: "driven-by"
    rationale: "AD-c6c2d9fb requires enforcement to accompany rule promotion — this epic implements that requirement across all layers"
  - target: "RES-b0268020"
    type: "guided-by"
