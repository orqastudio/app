...
Originally scoped as a CodeMirror-based editing UI, this epic was briefly absorbed into [EPIC-9ddef7f9](EPIC-9ddef7f9). It is now restored as a standalone epic with a fundamentally different approach: artifact mutations (create, edit, delete) are **proposals** sent to the AI conversation panel, not direct file operations.
