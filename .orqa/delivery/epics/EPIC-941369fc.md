...
The CLI reads all rules, resolves which mechanisms apply, and runs them.
Same logic as pre-commit but on-demand and targetable. The `--report`
flag produces a matrix: every rule, every mechanism, pass/fail/skipped.
