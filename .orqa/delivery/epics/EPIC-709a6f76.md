...
Capabilities **replace** tools entirely — the rule (RULE-8abcbfd5) owns the mapping
...
### Phase 3: Companion Plugin Resolution (when [EPIC-9a1eba3f](EPIC-9a1eba3f) lands)
...
- [ ] [TASK-9726f126](TASK-9726f126): Create [RULE-8abcbfd5](RULE-8abcbfd5) defining capability vocabulary and provider mappings
- [ ] [TASK-ac3c54b4](TASK-ac3c54b4): Update [RULE-87ba1b81](RULE-87ba1b81) and [RULE-dd5b69e6](RULE-dd5b69e6) for capability-based delegation

### Phase 2: Agent Definition Migration
- [ ] [TASK-34dc7474](TASK-34dc7474): Update agent schema — replace `tools` with `capabilities`
- [ ] [TASK-eab05905](TASK-eab05905): Migrate all 7 agent definitions from `tools` to `capabilities`
- [ ] [TASK-ac3c54b4](TASK-ac3c54b4): Update [RULE-87ba1b81](RULE-87ba1b81) and [RULE-dd5b69e6](RULE-dd5b69e6) for capability-based delegation

### Phase 3: Plugin Resolution (depends on EPIC-9a1eba3f)
- [ ] [TASK-f8ea54b9](TASK-f8ea54b9): Implement capability resolution in companion plugin SubagentStart hook

### Phase 4: App-Native Resolution
- [ ] [TASK-b9b8d409](TASK-b9b8d409): Implement capability resolution in Rust agent execution pipeline
