...
# EPIC-4a107943: Organisation-mode multi-project support
...
- Cross-project relationships are resolved: `EPIC-797972a7` in the SDK project can reference `TASK-5ebf808b` in the app project via qualified IDs (`sdk:EPIC-797972a7 → app:TASK-5ebf808b`)
