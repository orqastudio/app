...
scoring:
  ...
  dependencies: 3
relationships:
  - target: TASK-d260e020
    type: delivered-by
    rationale: Epic contains this task
  - target: TASK-151602a7
    type: delivered-by
    rationale: Epic contains this task
  - target: TASK-fa8496a2
    type: delivered-by
    rationale: Epic contains this task
  - target: TASK-8505081b
    type: delivered-by
    rationale: Epic contains this task
  - target: TASK-2f248471
    type: delivered-by
    rationale: Epic contains this task
  - target: TASK-0f5e46a6
    type: delivered-by
    rationale: Epic contains this task
  - target: TASK-c9bef1d6
    type: delivered-by
    rationale: Epic contains this task
...
- **#28** (verification artifact type) — schema exists, awaiting EPIC-88f359b0 TASK-J for first instances
...
| 16 | Svelte error: duplicate key `RULE-dccf4226relationships` in ReferencesPanel |
