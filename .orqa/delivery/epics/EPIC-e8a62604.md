...
orqa plugin diff
  @orqastudio/plugin-agile-governance:
    RULE-633e636d.md: identical
    RULE-57ccb4a3.md: MODIFIED (3 lines changed)
    KNOW-e4b91f37.md: identical

  @orqastudio/plugin-core:
    AGENT-1dab5ebe.md: identical
    RULE-029db175.md: MISSING (deleted from .orqa/)
