...
relationships:
  - target: "RES-156f2188"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-156f2188"
  - target: "RES-63cda7a7"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-63cda7a7"
  - target: "RES-f7bd7ab1"
    type: "guided-by"
    rationale: "Auto-generated inverse of informed-by relationship from RES-f7bd7ab1"
...
### Part 2: Backend Artifact Node Graph ([RES-f7bd7ab1](RES-f7bd7ab1), [RES-156f2188](RES-156f2188))
...
### Part 3: Frontend Artifact Graph SDK [RES-156f2188](RES-156f2188)
...
- Note: full snapshot approach will need to become incremental when graph expands to full codebase (see [IDEA-7f5c18e9](IDEA-7f5c18e9))
...
### Plugin Development Skill [TASK-38b82d46](TASK-38b82d46)
...
This protects production governance data during development. The skill references [IDEA-5113eeae](IDEA-5113eeae) for the distribution architecture that will be built in the next phase.

## Out of Scope

- Graph visualization UI (node/edge rendering) — separate epic
- App-assisted template pre-population (artifact editor) — deferred to [EPIC-320d1a2f](EPIC-320d1a2f)
- Full-codebase graph expansion — captured as [IDEA-7f5c18e9](IDEA-7f5c18e9)
- Plugin runtime, loading, and distribution mechanism — captured as [IDEA-5113eeae](IDEA-5113eeae)
- Artifact write operations via SDK — [EPIC-320d1a2f](EPIC-320d1a2f) scope
...
| [TASK-13c474e0](TASK-13c474e0) | Build backend artifact node graph with bidirectional references | backend/src-tauri/src/domain/ |
| [TASK-e86dc6a2](TASK-e86dc6a2) | Add artifact graph Tauri commands | backend/src-tauri/src/commands/ |
| [TASK-27d91d91](TASK-27d91d91) | Build frontend Artifact Graph SDK with subscription API | ui/src/lib/sdk/ |
| [TASK-7f13e4a6](TASK-7f13e4a6) | Migrate stores to SDK: replace artifact/navigation store ad-hoc patterns | ui/src/lib/stores/ |
| [TASK-4b7c5d82](TASK-4b7c5d82) | Migrate viewer components to SDK: frontmatter from graph, link handling | ui/src/lib/components/artifact/*Viewer.svelte |
| [TASK-2a19d2d1](TASK-2a19d2d1) | Migrate nav and linking to SDK: ArtifactLink, ArtifactNav, FrontmatterHeader, AppLayout | ui/src/lib/components/ |
| [TASK-25368885](TASK-25368885) | Broken link styling and path validation | ui/src/lib/components/artifact/ |
| [TASK-021790b8](TASK-021790b8) | Markdown cross-linking in MarkdownRenderer | ui/src/lib/components/shared/ |
| [TASK-a4417705](TASK-a4417705) | File watcher for .orqa/ with graph rebuild and event emission | backend/src-tauri/src/ |
| [TASK-16ff9010](TASK-16ff9010) | Write Artifact Graph SDK documentation | .orqa/documentation/development/ |
| [TASK-38b82d46](TASK-38b82d46) | Create orqa-plugin-development skill (new project + seed data approach) | .orqa/process/skills/ |
...
TASK-13c474e0 (backend graph) ──> TASK-e86dc6a2 (Tauri commands) ──> TASK-27d91d91 (frontend SDK)
  ──> TASK-7f13e4a6 (migrate stores)
    ──> TASK-4b7c5d82 (migrate viewers)
    ──> TASK-2a19d2d1 (migrate nav/linking)
      ──> TASK-25368885 (broken links)
      ──> TASK-021790b8 (markdown cross-links)

TASK-13c474e0 (backend graph) ──> TASK-a4417705 (file watcher)

Track C — Documentation (after migration proves the SDK):
TASK-2a19d2d1 (migration complete) ──> TASK-16ff9010 (SDK docs) ──> TASK-38b82d46 (plugin skill)
```

Tracks A and B are independent and can be parallelized. Track C depends on the migration being complete — the SDK docs describe the proven API, not a speculative one. Within Track B, [TASK-4b7c5d82](TASK-4b7c5d82) and [TASK-2a19d2d1](TASK-2a19d2d1) can be parallelized after [TASK-7f13e4a6](TASK-7f13e4a6). [TASK-25368885](TASK-25368885) and [TASK-021790b8](TASK-021790b8) can be parallelized after [TASK-2a19d2d1](TASK-2a19d2d1).