...
- `tmp/business-logic-duplication-audit.md` — full audit findings with file locations, risk assessment, and consolidation priorities
- [RES-d7a4f1c9](RES-d7a4f1c9) — source of truth duplication audit research artifact
...
|----|-------|----------|------------|
| [TASK-140e2028](TASK-140e2028) | Replace status transition hook with daemon delegation | P1 | — |
| [TASK-28789c27](TASK-28789c27) | Fix MCP server frontmatter missing trim | P1 | — |
| [TASK-56628529](TASK-56628529) | Migrate CLI graph scanner to daemon API | P2 | — |
| [TASK-9043c368](TASK-9043c368) | Migrate schema validation hooks to daemon delegation | P2 | — |
| [TASK-13c4355e](TASK-13c4355e) | Consolidate Cytoscape analysis to Rust daemon endpoints | P2 | — |
| [TASK-a48bbc43](TASK-a48bbc43) | Consolidate frontmatter parsing to SDK single export | P3 | — |
| [TASK-27cb554b](TASK-27cb554b) | Migrate relationship validation hooks to daemon delegation | P3 | — |
| [TASK-c4718ed7](TASK-c4718ed7) | Fix pre-commit hook extension and integer expression bug | P1 | — |
| [TASK-a0f9197e](TASK-a0f9197e) | Reconcile EPIC-5ab0265a | — | all above |
