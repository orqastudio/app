...
relationships:
  - type: informs
    target: AD-014
    rationale: Inverse of informed-by relationship from AD-014
  - type: informs
    target: AD-015
    rationale: Inverse of informed-by relationship from AD-015
  - type: informs
    target: AD-016
    rationale: Inverse of informed-by relationship from AD-016
  - target: DOC-061
    type: documented-by
    rationale: "Referenced in documentation page Wireframe: Settings & Onboarding"
---
...
- [Claude Integration Research](RES-002) — Q1 option (c) depends on API
- [Persistence Research](RES-006) — Q2 option (c) depends on SQLite schema
