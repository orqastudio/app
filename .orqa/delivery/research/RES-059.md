...
relationships:
  - target: EPIC-066
    type: informs
    rationale: "Testing framework is TASK-424 in the package ecosystem epic"
  - target: RES-058
    type: informed-by
    rationale: "SDK extraction research identified the store testing patterns that need to be portable"
---
...
it("detects broken refs", () => {
  const graph = createTestGraph([
    createTestNode({ id: "TASK-001", frontmatter: { epic: "EPIC-999" } }),
  ]);
