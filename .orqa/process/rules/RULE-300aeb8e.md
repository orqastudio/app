...
- [RULE-c71f1c3f](RULE-c71f1c3f) (development-commands) — defines the make targets used for rebuilding and restarting
- [RULE-6083347d](RULE-6083347d) (dogfood-mode) — stale binaries are especially dangerous in dogfood mode where the running app IS the development environment
- [RULE-633e636d](RULE-633e636d) (git-workflow) — the rebuild step integrates into the commit workflow defined here
