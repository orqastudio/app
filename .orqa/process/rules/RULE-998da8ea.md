...
1. Write session state to `.state/session-state.md` (tasks completed, in-progress work, what to resume)
...
5. The session ends when the app restarts. The next session picks up from `.state/session-state.md`.
...
- [RULE-43f1bebc](RULE-43f1bebc) (systems-thinking) — universal rule that applies to all projects; dogfood mode heightens its urgency
- [RULE-d2c2063a](RULE-d2c2063a) (development-commands) — `make dev` and `make restart-tauri` commands
- [RULE-9814ec3c](RULE-9814ec3c) (coding-standards) — general coding standards apply regardless of dogfood mode