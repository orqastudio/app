...
See [RULE-b10fe6d1](RULE-b10fe6d1) (artifact-lifecycle) for the full artifact lifecycle and `.orqa/documentation/guide/artifact-workflow.md` for day-to-day workflow.
...
See [RULE-8ee65d73](RULE-8ee65d73) (no-deferred-deliverables) for the full enforcement rule.
...
Without loop closure, enforcement tooling is created but never run against the codebase that prompted its creation. The findings that motivated the epic go unaddressed. Deferring findings to future epics violates [RULE-8ee65d73](RULE-8ee65d73) — if the tooling is in scope, its findings are in scope.
...
- [RULE-b10fe6d1](RULE-b10fe6d1) (artifact-lifecycle) — artifact creation, status transitions, promotion gates
- [RULE-1b238fc8](RULE-1b238fc8) (vision-alignment) — the pillar framework that plans must serve
- [RULE-05ae2ce7](RULE-05ae2ce7) (architecture-decisions) — the architecture decisions plans must comply with
- [RULE-9814ec3c](RULE-9814ec3c) (coding-standards) — the standards implementations must meet
