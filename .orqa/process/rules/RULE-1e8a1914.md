...
description: Every feature must serve at least one active pillar defined in .orqa/principles/pillars/.
status: active
created: 2026-03-07
updated: 2026-03-13
enforcement:
...
relationships:
  ...
  - target: DOC-1bc9d0b9
    type: documented-by
---
Every feature, command, and UI element must serve the project's guiding principles. These principles are defined as **pillar artifacts** in `.orqa/principles/pillars/`. Read the active pillars before implementing any new capability.
...
**Source of truth:** `.orqa/principles/pillars/PILLAR-NNN.md` files. Do not hardcode pillar names or descriptions in rules, documentation, or agent instructions — always reference the pillar artifacts.
...
1. **Read active pillars** from `.orqa/principles/pillars/`
...
- The pillar framework (active pillars defined in `.orqa/principles/pillars/`)
