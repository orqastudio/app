...
2. **CRITICAL_RULE_IDS injection** — the `CRITICAL_RULE_IDS` constant in `connectors/claude-code/src/hooks/prompt-injector.ts` states this rule explicitly so orchestrating agents cannot claim ignorance.
