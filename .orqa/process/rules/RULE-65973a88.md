...
- RULE-1acb1602 (end-to-end-completeness) — decisions define the layer requirements (IPC boundary, component purity, type safety) that every feature must satisfy