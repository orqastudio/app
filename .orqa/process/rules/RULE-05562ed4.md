...
summary: "Every documentation page describing a feature must include a Pillar Alignment section with a row per active pillar. Read pillars from .orqa/process/pillars/. Pages serving no pillar are scope creep. Exempt: research pages, dev guidelines, pillar definitions, vision/governance pages, architecture decisions."
tier: stage-triggered
roles: [writer, reviewer]
priority: P2
tags: [documentation, pillar-alignment, scope-control]
relationships:
  - target: "AD-74a2cb7a"
    type: "enforces"
---
...
- [RULE-1b238fc8](RULE-1b238fc8) (vision-alignment) — governs pillar alignment for features and implementation; this rule extends the same requirement to documentation pages
- [RULE-ec9462d8](RULE-ec9462d8) (documentation-first) — documentation is the source of truth; this rule ensures docs remain aligned with the product vision
- [RULE-b10fe6d1](RULE-b10fe6d1) (artifact-lifecycle) — documentation gates on epics (`docs-required`, `docs-produced`) produce pages that must include pillar alignment sections
