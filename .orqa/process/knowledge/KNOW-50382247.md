...
priority: "P1"
summary: |
  Svelte 5 runes, snippets, SvelteKit patterns. Covers
  $state/$derived/$effect/$props, event handling, data loading, form actions,
  TypeScript props typing, SSR state isolation.
---
## Quick Reference
