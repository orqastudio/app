...
These agents live in project-specific plugin directories and inherit from the generic Implementer (AGENT-cc255bc8):
...
The Governance Steward (AGENT-fbdfa9ef) operates in three roles:
...
The Plugin Developer (AGENT-34a6e2cd) handles all plugin-related work:
...
|-------|--------|---------|
| **Governance Enforcer** | `@orqastudio/plugin-agile-governance` | Designs mechanical enforcement for rules |
...
| Code review | Generic Reviewer (AGENT-ec1b3785) | Independent verification |
