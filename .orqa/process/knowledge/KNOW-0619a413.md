...
priority: "P2"
summary: |
  Composability philosophy: building systems from small, pure, swappable units.
  Meta-skill that informs all patterns — function-level and feature-level. The
  most fundamental design principle.
---
