...
priority: "P0"
summary: |
  Planning thinking mode: scopes, breaks down, prioritises, and designs work
  before execution. Documentation-first, user approval gates. Triggered by
  plan/scope/design signals.
---
