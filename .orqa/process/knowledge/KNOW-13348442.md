...
priority: "P1"
summary: |
  Search methodology: three modes — regex for exact patterns, semantic for
  natural language, research for compound queries. Search before creating, find
  callers before refactoring.
---
# Search
