...
priority: "P0"
summary: |
  Learning loop thinking mode: captures surprising outcomes or process failures
  as lesson artifacts. Lessons may promote to rules after review. Structure:
  observation, hypothesis, evidence, recommendation.
---
