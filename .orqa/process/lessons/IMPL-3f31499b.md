...
Documentation browsing is a first-class feature of OrqaStudio, not a bolted-on external tool. The artifact scanner reads markdown files directly, extracts frontmatter, and renders them in the app's artifact panel. This was formalized in [AD-f9fbd1d7](AD-f9fbd1d7) and [AD-45cfe1d1](AD-45cfe1d1).
