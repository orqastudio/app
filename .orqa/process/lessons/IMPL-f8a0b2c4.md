...
The frontend (app/ui/) MUST NEVER make direct HTTP calls to local services (daemon, search server, MCP, etc.). All communication goes through Tauri commands. This is an architectural constraint from the IPC boundary decision (AD-e513c9e4).
