...
3. **Findings MUST be written to disk** at `.state/team/<team-name>/task-<id>.md` per RULE-04684a16
...
Promoted to [RULE-99abcea1](RULE-99abcea1) which codifies the Agent Teams requirement. Also added to CLAUDE.md Safety section as a NON-NEGOTIABLE constraint. Memory entry `feedback_use_agent_teams.md` captures this for cross-session persistence.
...
- Missing `team_name` triggers a systemMessage warning citing RULE-99abcea1
