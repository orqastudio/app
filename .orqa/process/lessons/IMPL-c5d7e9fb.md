...
The orchestrator was acting as its own reviewer and skipped the lesson step. RULE-551bde31 requires review agents to log lessons on FAIL verdicts, but when the orchestrator self-reviews (fixes its own mistakes), the lesson creation step is dropped in favour of moving forward.
