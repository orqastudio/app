...
relationships:
  - target: "RULE-8abcbfd5"
    type: "enforced-by"
    rationale: "RULE-8abcbfd5 generalises provider-agnosticism to all agent capabilities — agents declare capabilities not tool names, enforcing the same provider-agnostic pattern at the governance layer that this AD establishes at the sidecar layer"
