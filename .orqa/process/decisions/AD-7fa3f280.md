...
relationships:
  - target: RULE-b10fe6d1
    type: enforced-by
    rationale: RULE-b10fe6d1 referenced in decision body
  - target: RULE-d5d28fba
    type: enforced-by
    rationale: RULE-d5d28fba referenced in decision body
  - target: DOC-28344cd7
    type: documented-by
---
...
- [RULE-b10fe6d1](RULE-b10fe6d1) (artifact lifecycle) needs updating to respect the project config
...
- Update [RULE-b10fe6d1](RULE-b10fe6d1): Epic enforcement reads project config instead of hardcoding
- Update [RULE-d5d28fba](RULE-d5d28fba): "Structure before work" minimum is "task" when `epics-required: false`
