...
relationships:
  - target: "PILLAR-001"
    type: "grounded"
    rationale: "Provider-agnostic architecture creates structured AI abstraction layer"
  - target: "RULE-040"
    type: "enforced-by"
    rationale: "RULE-040 generalises provider-agnosticism to all agent capabilities — agents declare capabilities not tool names, enforcing the same provider-agnostic pattern at the governance layer that this AD establishes at the sidecar layer"
  - target: EPIC-040
    type: informs
  - target: PILLAR-001
    type: informs
