...
relationships:
  ...
  - target: "AD-b741a7df"
    type: "evolves-from"
    rationale: "AD-b741a7df called for MCP and LSP as separate managed processes; this decision consolidates them into CLI protocol modes"
  - target: "AD-5e87a65b"
    type: "evolves-from"
    rationale: "AD-5e87a65b described central LSP/MCP registration via plugin manifests as separate servers; this decision makes them CLI modes instead"
  - target: "AD-7d3d7521"
    type: "evolves-from"
...
The previous architecture (AD-b741a7df) called for MCP and LSP as separate managed processes launched by the dev controller. This created unnecessary complexity:
...
### Keep MCP and LSP as separate TCP servers (REJECTED — AD-b741a7df original)
