...
description: |
  Frontend libraries: shadcn-svelte, CodeMirror 6, PaneForge, LayerChart, lucide-svelte, custom conversation UI.
status: accepted
created: 2026-03-02
updated: 2026-03-02
relationships:
  ...
  - target: RULE-006
    type: enforced-by
    rationale: RULE-006 enforces coding standards including shadcn-svelte component library usage and Svelte 5 runes-only patterns
  - target: SKILL-042
    type: practiced-by
    rationale: The frontend-best-practices skill teaches agents how to use the selected frontend libraries correctly
  - target: DOC-016
    type: documented-by
