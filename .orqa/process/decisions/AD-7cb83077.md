...
description: "Three-zone layout with Activity Bar, Nav Sub-Panel, Explorer, and Chat. Session switching via dropdown. Supersedes AD-85d45674."
status: "completed"
created: "2026-03-02"
updated: "2026-03-02"
relationships:
  - target: "RES-80a476c7"
    type: "informed-by"
    rationale: "RES-80a476c7 evaluated panel layout libraries, confirming PaneForge supports the three-zone resizable layout with collapsible nav sub-panel"
  - target: "DOC-b4099ea3"
    type: "documented-by"
  - target: "DOC-248d74e2"
    type: "documented-by"
...
The four-zone layout [AD-85d45674](AD-85d45674) dedicated 240px to a Sessions Panel that served a low-frequency action (session switching). A dropdown in the Chat Panel header is more space-efficient. The 26+ documentation pages across 6 sections cannot be navigated effectively in a flat Explorer list — a structured tree in the Nav Sub-Panel solves this. Project info (hidden behind a tab in the Sessions Panel) deserves first-class Activity Bar status as a dashboard. The three-zone layout reclaims horizontal space and adds structured sub-navigation for deep hierarchies.

## Supersedes

[AD-85d45674](AD-85d45674) (four-zone layout). [AD-85d45674](AD-85d45674)'s Activity Bar concept and library selections remain — only the zone count and panel arrangement change.
