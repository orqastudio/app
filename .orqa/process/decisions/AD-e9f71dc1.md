...
created: 2026-03-25
updated: 2026-03-25
description: "Resolutions for the 10 open questions raised in RES-55bacef1 (Agent Team Design v2). Covers workflow inheritance, guard language, cross-plugin coupling, versioning, summary generation, latency, budgets, daemon boundary, migration strategy, and backwards compatibility."
relationships:
  - target: RES-55bacef1
    type: informed-by
    rationale: "Resolves the open questions raised in section 11 of the research"
---

## Decision

The following resolutions were agreed for the open questions in RES-55bacef1:
...
- `tmp/` directory renamed to `.state/` (see AD-8727f99a)
