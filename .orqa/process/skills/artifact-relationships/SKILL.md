...
Plugins register additional relationships for their artifact types. The software-project plugin adds delivery, dependency, and bug-tracking relationships. These are documented in SKILL-SW-001.
