...
Companion skill for [RULE-d90112d9](RULE-d90112d9) (Systems Thinking First). The rule defines the constraint — "think in systems before touching code." This skill provides the methodology — how to actually do it.
