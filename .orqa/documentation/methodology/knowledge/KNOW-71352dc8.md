...
- `.orqa/process/lessons/[IMPL-5b380b2e](IMPL-5b380b2e).md` — origin lesson (systemic investigation)
- `.orqa/process/lessons/[IMPL-42dd183e](IMPL-42dd183e).md` — origin lesson (encode, don't just practice)
