...
id: "KNOW-e3432947"
type: "knowledge"
title: "plugin-canonical-architecture"
...
priority: "P1"
summary: |
  Plugin-canonical architecture: plugins are the source of truth for all app
  content. .orqa/ contains installed copies plus dev-only artifacts. Explains
  content flow and the docs-knowledge pairing rule.
---
...
**Examples:** `plugins/core/knowledge/`, `plugins/core/rules/`, `plugins/software-kanban/knowledge/`
...
**Examples:** `.orqa/process/decisions/`, `.orqa/process/lessons/`, `.orqa/implementation/`, `.orqa/documentation/`
...
- [PD-26d8d45d](PD-26d8d45d) — architecture decision formalising this model
