...
priority: "P2"
summary: |
  Artifact audit methodology: schema-driven audit for governance artifacts.
  Validates reference integrity, relationship vocabulary, cross-layer
...
Audit findings are recorded as a research document in the project's `.orqa/discovery/research/` directory:
