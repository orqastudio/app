...
This design was formalised in [PD-a44384d1](PD-a44384d1).
...
The daemon starts via the app or via `orqa daemon start` for headless/CI use. It listens on port 10100.
...
The previous architecture ([PD-b741a7df](PD-b741a7df)) required separate MCP and LSP server processes with their own ports and lifecycle management. This design eliminates:
...
- [PD-a44384d1](PD-a44384d1) — Architecture decision: CLI as single interface, daemon as app runtime
