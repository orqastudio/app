...
The authoritative design system specification for OrqaStudio™'s UI. Consolidates decisions from [design-tokens research](RES-2d91e2c2), [branding research](RES-a5d10705), [frontend research](RES-80a476c7), and brand identity guidelines into an implementation-ready reference.
...
Auto-generated as `.orqa/process/rules/design-system.md` during codebase scan if design tokens are detected. Path-scoped to frontend files via `paths:` frontmatter. User approval required before writing. See [branding research Q2](RES-a5d10705) for full specification.
...
| [Frontend Research](RES-80a476c7) | Component library selection, markdown rendering, panel layout, charts |
