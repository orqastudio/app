...
- Lesson artifacts live in `.orqa/learning/lessons/` with `type: lesson`
- Recurring lessons (seen 2+ times) MUST be promoted to rules — this is non-negotiable
- RULE-998da8ea (dogfood mode): enforcement gaps discovered during development are immediately CRITICAL
