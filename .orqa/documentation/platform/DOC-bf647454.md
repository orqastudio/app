...
> **Archived 2026-04-13:** Completely stale directory structure. References `process/` and `delivery/` paths that no longer exist. A new getting-started guide will be written post-SurrealDB migration.
