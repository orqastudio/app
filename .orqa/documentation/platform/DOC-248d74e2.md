...
**Date:** 2026-03-03 | **Status:** Active | **Decision:** [PD-7cb83077](PD-7cb83077) — File-based project settings
...
1. **Platform defaults (`libs/types/src/platform/core.json`)** — Canonical artifact types, relationships, semantic categories, and navigation shipped with OrqaStudio. Every project inherits these. They cannot be overridden by project config.
  ...
  "artifacts": [
    {
      ...
      "icon": "compass",
      "children": [
        { "key": "pillar", "label": "Pillars", "icon": "columns-3", "path": ".orqa/discovery/pillars" },
        { "key": "vision", "label": "Vision", "icon": "eye", "path": ".orqa/discovery/vision" },
        { "key": "persona", "label": "Personas", "icon": "users", "path": ".orqa/discovery/personas" }
      ]
    },
    {
      "key": "discovery",
    ...
    },
    {
      ...
      "icon": "package",
      "children": [
        { "key": "milestone", "label": "Milestones", "icon": "flag", "path": ".orqa/implementation/milestones" },
        { "key": "epic", "label": "Epics", "icon": "layers", "path": ".orqa/implementation/epics" },
        { "key": "task", "label": "Tasks", "icon": "check-square", "path": ".orqa/implementation/tasks" }
      ]
    }
  ]
}
...
| Field | Type | Required | Description |
| ------- | ------ | ---------- | ------------- |
| `key` | `string` | Yes | Unique key for the group (e.g. `"discovery"`, `"delivery"`) |
