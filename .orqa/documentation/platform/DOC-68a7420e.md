...
All 7 universal roles are defined in `.orqa/process/agents/`. Each role is invoked via the Task tool with the appropriate `subagent_type`, and domain capability is loaded via knowledge at delegation time (see [AD-48b310f9](AD-48b310f9)).
...
Orchestrator-injected Tier 2 knowledge narrows the Implementer and Reviewer roles to specific domains. See the delegation guide above and [AD-48b310f9](AD-48b310f9) for the full knowledge-loading model.
