...
relationships:
  - target: RULE-1b238fc8
    type: documents
    rationale: This document defines the feature governance framework and pillar alignment criteria that RULE-1b238fc8 enforces
---

> **Archived 2026-04-13:** Superseded by CLAUDE.md and the discovery artifact system (`.orqa/discovery/`). Content describes bootstrap-phase work that is complete.
...
| **Lesson** | A learned pattern — captures *what was discovered* | Records mistakes, non-obvious behaviors, reusable insights | `[IMPL-bc62d0ba](IMPL-bc62d0ba): unwrap causes panics in sidecar` |
