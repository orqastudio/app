...
├─────────────────────────────────┤
│ Active Rules (n)                │
│  ▸ RULE-b10fe6d1  No `any` type      │
│  ▸ RULE-b10fe6d1  No Svelte 4        │
│  ▸ RULE-d2c2063a  No todo!()         │
│  ▼ RULE-ec9462d8  No --no-verify     │
...
├─────────────────────────────────────────────────────┤
│ Blocked by RULE-b10fe6d1-001: No `any` type in TypeScript│
...
├─────────────────────────────────────────────────────┤
│ Warning from RULE-ec9462d8-003: Destructive git command  │
