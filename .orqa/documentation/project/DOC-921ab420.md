...
relationships:
  - target: "AD-7121ec20"
    type: "documents"
    rationale: "Documentation page references AD-7121ec20"
  - target: "AD-2d58941b"
    type: "documents"
    rationale: "Documentation page references AD-2d58941b"
  - target: "AD-b08f456d"
    type: "documents"
    rationale: "Documentation page references AD-b08f456d"
---
**References:** [Claude Integration](RES-b666c725), [Tauri v2](RES-7b24ff49), [Persistence](RES-ac474863)

Module tree, domain types, command handlers, and dependency graph for `backend/src-tauri/src/`. Rust owns the domain model [AD-7121ec20](AD-7121ec20). All functions return `Result<T, E>` [AD-2d58941b](AD-2d58941b). No `unwrap()`, `expect()`, or `panic!()` in production code.
...
│   ├── skill_injector.rs            # Path-to-skill injection engine (RULE-e1f1afc1): maps file patterns to skills
...
- [AD-7121ec20](AD-7121ec20) — thick backend principle
- [AD-2d58941b](AD-2d58941b) — error propagation via Result + thiserror
- [AD-b08f456d](AD-b08f456d) — repository pattern
