...
relationships:
  - target: "PD-7121ec20"
    type: "documents"
    rationale: "Documentation page references PD-7121ec20"
  - target: "PD-2d58941b"
    type: "documents"
    rationale: "Documentation page references PD-2d58941b"
  - target: "PD-b08f456d"
    type: "documents"
    rationale: "Documentation page references PD-b08f456d"
---
**References:** [Claude Integration](RES-b666c725), [Tauri v2](RES-7b24ff49), [Persistence](RES-ac474863)

Module tree, domain types, command handlers, and dependency graph for `app/src-tauri/src/`. Rust owns the domain model [PD-7121ec20](PD-7121ec20). All functions return `Result\<T, E\>` [PD-2d58941b](PD-2d58941b). No `unwrap()`, `expect()`, or `panic!()` in production code.
...
- [PD-7121ec20](PD-7121ec20) — thick backend principle
- [PD-2d58941b](PD-2d58941b) — error propagation via Result + thiserror
- [PD-b08f456d](PD-b08f456d) — repository pattern
