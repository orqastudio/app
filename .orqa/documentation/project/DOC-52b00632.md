...
relationships:
  ...
  - target: PD-d01b9e0a
    type: documents
    rationale: Documentation page references PD-d01b9e0a
  - target: PD-af88bb69
    type: documents
    rationale: Documentation page references PD-af88bb69
---
...
**Architecture References:** [PD-09fc4e65](PD-09fc4e65) (sidecar integration), [PD-e4a3b5da](PD-e4a3b5da) (tool implementation as MCP), [PD-d01b9e0a](PD-d01b9e0a) (security model), [PD-af88bb69](PD-af88bb69) (composability principle)
...
Each tool is implemented natively in Rust within `app/src-tauri/src/domain/tools/`. No shelling out to external programs (except for `orqa_bash`, which executes user-specified commands under controlled scope).

```text
app/src-tauri/src/domain/tools/
...
**Built-in tools** operate within Tauri's file system security scopes [PD-d01b9e0a](PD-d01b9e0a):
...
- [PD-09fc4e65](PD-09fc4e65), [PD-e4a3b5da](PD-e4a3b5da), [PD-d01b9e0a](PD-d01b9e0a), [PD-af88bb69](PD-af88bb69)
