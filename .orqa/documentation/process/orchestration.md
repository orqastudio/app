...
> **Temporary process.** This CLI-based orchestration model serves as scaffolding until OrqaStudio™'s MVP can manage its own development. See [Product Governance — Bootstrap Phase](/product/governance) for transition criteria.
...
- [Team Overview](/process/team) -- Agent directory, skill directory, review gate overview
- [Workflow](/process/workflow) -- Full development workflow including merge conflicts and commit conventions
- [Definition of Ready](/process/definition-of-ready) -- Gate checklist before implementation starts
- [Definition of Done](/process/definition-of-done) -- Gate checklist before task is marked complete
- [Content Governance](/process/content-governance) -- Content layer ownership model
