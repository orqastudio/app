...
summary: "End-to-end functional verification methodology. This skill teaches the *verification process* — the specific layers and boundaries to trace through come from the project's architecture skills."
description: |
