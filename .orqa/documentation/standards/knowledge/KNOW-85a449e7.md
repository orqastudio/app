...
domain: standards/naming
description: "Reference for GitHub repo, folder, and npm package naming conventions for every OrqaStudio component category (library, plugin, connector, registry, tool)."
status: active
relationships:
  - target: DOC-e42efeaf
...
priority: "P2"
summary: |
  Naming conventions: repo, folder, and npm package naming for libraries,
  plugins, connectors, registry, tools, and templates. The name encodes the
  purpose.
