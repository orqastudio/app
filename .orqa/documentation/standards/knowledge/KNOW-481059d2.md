...
description: "How OrqaStudio's single canonical version is stored and propagated across all package.json, Cargo.toml, and plugin manifest files."
tier: stage-triggered
summary: "Version Management. OrqaStudio uses a single canonical version across all repositories. The `VERSION` file at the dev repo root is the source of truth."
status: active
