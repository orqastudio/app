...
description: "How to choose the correct license for a new OrqaStudio component and evaluate whether a given use case is permitted under BSL-1.1 with Ethical Use Addendum."
status: active
category: domain
user-invocable: true
relationships:
...
priority: "P2"
summary: |
  Licensing decisions: BSL-1.1 with Ethical Use Addendum for app/lib/plugin,
  Apache-2.0 for connectors, MIT for registry. Quick reference for permitted use
  cases.
...
PD-a7fd7461 defines the ethical licensing model. All licensing answers derive from it.
