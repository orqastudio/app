...
summary: "Methodology for inferring a project's characteristics from its file structure and configuration files. The output is a structured project profile that drives skill selection, rule loading, and setup decisions."
description: |
