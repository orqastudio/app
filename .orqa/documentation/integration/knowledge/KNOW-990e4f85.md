...
id: KNOW-990e4f85
type: knowledge
title: OrqaStudio CLI Usage
domain: integration/cli
description: "Reference for orqa CLI commands for browsing the artifact graph, running validation, managing plugins, and checking versions."
tier: on-demand
summary: "OrqaStudio CLI Usage. The `orqa` CLI is the command-line interface for OrqaStudio. Use it instead of raw file operations when working with the artifact graph, plugins, or validation."
status: active
...
orqa graph --related-to PD-ee2910b1
