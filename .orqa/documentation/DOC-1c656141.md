...
Artifacts are markdown files with YAML frontmatter, stored in `.orqa/` directories. Each artifact has a type (rule, knowledge, doc, agent, idea, decision, etc.), an ID (`RULE-65973a88`, `KNOW-b05e7294`), and typed metadata in its frontmatter.
...
orqa graph --related-to KNOW-b05e7294       # Find related artifacts
orqa graph --id DOC-1c656141                # Read one artifact
```
...
- [KNOW-25919e07](KNOW-25919e07) — Agent-facing knowledge pair for this documentation page
- [DOC-7c1a3e51](DOC-7c1a3e51) — CLI Architecture (the developer interface into this workflow)
- [DOC-8d2b4f62](DOC-8d2b4f62) — Shared Validation Engine (implements enforcement Layers 1 and 3)
- [DOC-9e3c5073](DOC-9e3c5073) — Three-Layer Enforcement Model (detailed breakdown)
- [DOC-b05e7295](DOC-b05e7295) — Knowledge Auto-Injection (detailed injection mechanisms)
- [DOC-2330c9f6](DOC-2330c9f6) — Demoted Rule Stability Tracking (rule lifecycle after demotion)
