...
description: "Patterns for writing Svelte 5 components using runes-only state management, component structure, and SDK store integration."
tier: on-demand
summary: "Svelte 5 Patterns. Svelte 5 uses runes exclusively. No Svelte 4 patterns."
status: active
