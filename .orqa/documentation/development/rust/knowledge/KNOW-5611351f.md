...
priority: "P2"
summary: |
  OrqaStudio architecture: ADR patterns, data flow mapping, layer
  responsibilities, violation detection, IPC boundary design for
  Tauri+Svelte+Rust stack.
---
...
| IPC Commands | Validate input, orchestrate domain calls, serialize response | `app/src-tauri/src/commands/` |
| Domain | Business logic, pure functions, type definitions | `app/src-tauri/src/domain/` |
| Persistence | SQLite queries, file I/O, external API calls | `app/src-tauri/src/repo/` |
