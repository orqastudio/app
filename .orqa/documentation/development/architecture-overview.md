...
A contributor-friendly introduction to OrqaStudio™'s architecture. For detailed decisions, see individual decision artifacts in `.orqa/process/decisions/`.
...
- Architecture decisions — individual `AD-NNN.md` artifacts in `.orqa/process/decisions/`
