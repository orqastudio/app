...
status: accepted
description: >
  The artifact scanner reads paths from project.json config, not hardcoded
  constants. Directories are walked recursively like a file explorer.
  Frontmatter title is used for display labels.
created: 2026-03-08
updated: 2026-03-08
---
