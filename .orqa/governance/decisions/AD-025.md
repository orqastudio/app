...
status: accepted
description: >
  The AI integration layer uses a Provider interface. Claude is the first
  provider via ClaudeAgentProvider, but the architecture supports pluggable
  providers (direct API, mock, future models) without changing the NDJSON
  protocol or Rust backend.
created: 2026-03-07
updated: 2026-03-07
---
