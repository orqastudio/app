...
relationships:
  ...
  - target: RES-038
    type: informed-by
    rationale: Research RES-038 informed this decision
  - type: informed-by
    target: AD-034
    rationale: Inverse of informs relationship from AD-034
  - type: informed-by
    target: AD-037
    rationale: Inverse of informs relationship from AD-037
---
## Decision

Each artifact type directory (e.g. `.orqa/planning/epics/`, `.orqa/documentation/`) can contain a `_navigation.json` file with two mutually exclusive modes:
