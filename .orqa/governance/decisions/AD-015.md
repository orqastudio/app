...
description: |
  Governance artifacts use native Claude Code format (markdown + YAML frontmatter). OrqaStudio-specific metadata lives only in SQLite. Superseded by AD-021 which moves source of truth from .claude/ to .orqa/.
status: superseded
created: 2026-03-02
updated: 2026-03-08
research-refs:
  - mvp/onboarding.md
superseded-by: AD-021
---
## Decision
