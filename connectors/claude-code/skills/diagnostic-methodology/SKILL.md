...
description: "Root cause analysis methodology: capture, reproduce, isolate, fix, verify. Covers debug process, common issue categories, root cause classification, and the discipline of fixing causes not symptoms. Use when: Debugging failures, diagnosing unexpected behavior, tracing data flow through multi-layer systems, or investigating production issues."
user-invocable: true
---
