...
async function main() {
    ...
    logTelemetry("validate-artifact", "PostToolUse", startTime, findings.length === 0 ? "valid" : "invalid", { file: relPath, errors_found: errorFindings.length, warnings_issued: warnFindings.length }, projectDir);
