...
- `.claude/rules/plan-mode-compliance.md` — Plan mode requirements
- `.claude/rules/architecture-decisions.md` — AD-XXX quick reference
- `.claude/rules/vision-alignment.md` — Two-Pillar framework and governance
