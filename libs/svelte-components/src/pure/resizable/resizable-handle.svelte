<script lang="ts">
	...
	let {
		...
		withHandle = false,
		...restProps
	}: WithoutChildrenOrChild<Omit<ResizablePrimitive.PaneResizerProps, "class">> & {
		withHandle?: boolean;
	} = $props();
</script>
