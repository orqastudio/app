...
//!     orqa_lsp_server::run_stdio(project_root, 10258 /* or read ORQA_PORT_BASE */).await.expect("LSP server failed");
//! }
//! ```
//!
//! ## TCP (debugging)
...
//! async fn main() {
//!     let project_root = Path::new("/path/to/project");
//!     orqa_lsp_server::run_tcp(project_root, 9257, 10258 /* or read ORQA_PORT_BASE */).await.expect("LSP server failed");
//! }
//! ```
