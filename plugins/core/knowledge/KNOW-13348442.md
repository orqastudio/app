...
type: knowledge
title: Search
summary: "Structured search methodology with three modes: search_regex for exact patterns and callers, search_semantic for natural language concept search using vector embeddings, and search_research for compound deep-understanding queries that combine semantic search with symbol extraction and regex follow-up. Always search before creating new code to avoid duplicating existing functionality."
description: |
