...
The pre-commit adapter also logs violations to `tmp/precommit-violations.jsonl` for the stability tracker (see [DOC-2330c9f6](DOC-2330c9f6)).
...
- [KNOW-8d2b4f61](KNOW-8d2b4f61) — Agent-facing knowledge pair for this documentation page
- [DOC-9e3c5073](DOC-9e3c5073) — Three-Layer Enforcement Model (validation engine is Layer 1 and Layer 3)
- [DOC-2330c9f6](DOC-2330c9f6) — Demoted Rule Stability Tracking (uses pre-commit violation logging)
