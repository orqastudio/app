 ...
 */
function buildRulesFromEntries(entries) {
	const rules = {};
 ...
 */
function renderEslintConfig(tsRules, svelteRules) {
 ...
 */
function renderRulesObject(rules, indent) {
...
const tsEntries = filterByEngine(allRules, "eslint").flatMap((r) => r.enforcement);
const svelteEntries = filterByEngine(allRules, "eslint-svelte").flatMap((r) => r.enforcement);
