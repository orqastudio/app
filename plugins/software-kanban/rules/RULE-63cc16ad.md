...
| `.claude/knowledge/` | → `.orqa/documentation/knowledge/` |
| `.claude/hooks/` | → `.orqa/process/hooks/` |
| `.claude/CLAUDE.md` | → `.claude/agents/orchestrator.md` |
...
4. **New rules** go in `.orqa/learning/rules/`, new agents in `.claude/agents/`, new knowledge in `.orqa/documentation/knowledge/`
...
- end-to-end-completeness — config changes must be reflected across all layers
- [RULE-c382e053](RULE-c382e053) (no-aliases-or-hacks) — no alias paths or fallback path resolution
- [RULE-ec9462d8](RULE-ec9462d8) (documentation-first) — document the config schema before implementing
- [RULE-4603207a](RULE-4603207a) (enforcement-before-code) — create enforcement artifacts before implementation
