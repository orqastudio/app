...
relationships:
  - type: enforces
    target: PD-430829f1
    rationale: "Honest status reporting enforces the Knowledge Maturity Pipeline by ensuring governance signals (task completion, rule violations) are accurate"
---
