...
| -------- | -------------- | -------- |
| **Rule** | When establishing a new convention, fixing a recurring mistake, or introducing a constraint | `.orqa/learning/rules/` |
| **Knowledge** | When capturing reusable domain knowledge that agents need to implement correctly | `.orqa/documentation/knowledge/` |
| **Knowledge update** | When existing knowledge is incomplete or incorrect | Update existing knowledge in `.orqa/documentation/knowledge/` |
| **Lesson** | When a bug or mistake reveals a non-obvious pattern | `.orqa/learning/lessons/` |
| **Agent update** | When an agent's knowledge list or required reading needs to change | `.claude/agents/` |
...
- [RULE-ec9462d8](RULE-ec9462d8) (documentation-first) — documentation before code; this rule extends that to enforcement artifacts
- [RULE-c603e90e](RULE-c603e90e) (lessons-learned) — lessons are one type of enforcement artifact
- [RULE-dd5b69e6](RULE-dd5b69e6) (knowledge-enforcement) — knowledge must be loaded before implementation
