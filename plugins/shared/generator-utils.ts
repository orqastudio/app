 ...
 * @param engine
 */
export function filterByEngine(rules: readonly ParsedRule[], engine: string): ParsedRule[] {
	return rules
		.map((rule) => ({
			...rule,
 ...
 * @param engine
 */
export function resolveOutputPath(args: Readonly<GeneratorArgs>, engine: string): string {
