...
- Research (`.orqa/implementation/research/`)
- Tasks (`.orqa/implementation/tasks/`)
- Ideas (`.orqa/implementation/ideas/`) — use `status: archived` per existing lifecycle
- Lessons (`.orqa/learning/lessons/`) — use `promoted_to` field per existing lifecycle
