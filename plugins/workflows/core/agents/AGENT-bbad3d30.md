...
| Research documents | `.orqa/implementation/research/` | Investigations and analysis |
...
Every feature documentation page MUST include a Pillar Alignment section near the bottom. See [RULE-05562ed4](RULE-05562ed4) for details.
