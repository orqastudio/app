...
- Logs violations to `.state/precommit-violations.jsonl` for the stability tracker
...
Behavioral rule (Layer 2, active)
  ...
  (see DOC-a16b7bc7 for the full lifecycle)
        │
        ▼
...
- [KNOW-1f4aba8f](KNOW-1f4aba8f) — Agent-facing knowledge pair for this documentation page
- [DOC-dd5062c9](DOC-dd5062c9) — Shared Validation Engine (the engine powering Layers 1 and 3)
- [DOC-a16b7bc7](DOC-a16b7bc7) — Demoted Rule Stability Tracking (the lifecycle after demotion)
