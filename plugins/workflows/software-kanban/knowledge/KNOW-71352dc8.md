...
type: knowledge
title: UAT Process
summary: "Structured UAT methodology for the orchestrator and QA agents. Prevents premature fixing and ensures systemic solutions."
description: |
...
1. **Investigate architecture** — delegate to Explore agents to understand:
...
2. **Update the epic** with findings table and systemic themes
...
- [RULE-71352dc8](RULE-71352dc8) — UAT process enforcement rule
- [RULE-43f1bebc](RULE-43f1bebc) — systems thinking (systemic analysis principle)
- [RULE-c603e90e](RULE-c603e90e) — lessons learned (lesson promotion pipeline)
- `.orqa/learning/lessons/[IMPL-5b380b2e](IMPL-5b380b2e).md` — origin lesson (systemic investigation)
- `.orqa/learning/lessons/[IMPL-42dd183e](IMPL-42dd183e).md` — origin lesson (encode, don't just practice)
