...
class HTMLPlugin {
    constructor(docManager, configManager, fileSystemProvider, workspaceFolders) {
        ...
        this.loadedEmmetExtensionsPaths = '';
    ...
    reloadEmmetExtensionsIfNeeded() {
        ...
        if (this.loadedEmmetExtensionsPaths !== joinedPaths) {
            ...
            (0, emmet_helper_1.updateExtensionsPath)(extensionsPath, this.fileSystemProvider, this.workspaceFolders.map((folder) => vscode_uri_1.URI.parse(folder.uri))).catch((err) => logger_1.Logger.error(err));
        }
    }
