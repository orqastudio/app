...
- [RULE-9814ec3c](RULE-9814ec3c) (coding-standards) — function size limits apply to test helpers too
- [RULE-af5771e3](RULE-af5771e3) (no-stubs) — test doubles are NOT stubs; they implement real traits
- [RULE-0be7765e](RULE-0be7765e) (error-ownership) — failing tests are YOUR responsibility to fix
