 ...
 */
export declare function scanMatchingBraces(html: string, startOffset: number): BraceMatchResult;
export declare function isInsideMoustacheTag(text: string, tagStart: number, offset: number): boolean;
export {};
