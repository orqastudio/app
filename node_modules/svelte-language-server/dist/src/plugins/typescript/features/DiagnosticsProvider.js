...
exports.mapAndFilterDiagnostics = mapAndFilterDiagnostics;
            ...
            return [
                {
                    ...
                    source: tsDoc.scriptKind === typescript_1.default.ScriptKind.TSX ||
                        tsDoc.scriptKind === typescript_1.default.ScriptKind.TS
                        ? 'ts'
                        : 'js',
...
function mapAndFilterDiagnostics(diagnostics, document, tsDoc, lang) {
...
function rangeMapper(snapshot, document, lang) {
    const get$$PropsDefWithCache = (0, utils_3.memoize)(() => lang ? get$$PropsDef(lang, snapshot) : undefined);
    const get$$PropsAliasInfoWithCache = (0, utils_3.memoize)(() => lang ? get$$PropsAliasForInfo(get$$PropsDefWithCache, lang, document) : undefined);
    return (diagnostic) => {
...
function expectedTransitionThirdArgument(diagnostic, tsDoc, lang) {
    ...
    if (!lang) {
        ...
        return (0, typescript_1.flattenDiagnosticMessageText)(diagnostic.messageText, '\n').includes(' 3');
    }
