...
export declare function mapAndFilterDiagnostics(diagnostics: ts.Diagnostic[], document: Document, tsDoc: SvelteDocumentSnapshot, lang?: ts.LanguageService): Diagnostic[];
