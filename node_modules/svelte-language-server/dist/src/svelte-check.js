...
exports.mapSvelteCheckDiagnostics = mapSvelteCheckDiagnostics;
...
const DocumentSnapshot_1 = require("./plugins/typescript/DocumentSnapshot");
const utils_1 = require("./plugins/typescript/features/utils");
const DiagnosticsProvider_1 = require("./plugins/typescript/features/DiagnosticsProvider");
const utils_2 = require("./plugins/typescript/utils");
const utils_3 = require("./utils");
const lodash_1 = require("lodash");
function mapSvelteCheckDiagnostics(sourcePath, sourceText, tsDiagnostics, options) {
    const document = new documents_1.Document((0, utils_3.pathToUrl)(sourcePath), sourceText);
    const snapshot = DocumentSnapshot_1.DocumentSnapshot.fromDocument(document, {
    ...
    return (0, DiagnosticsProvider_1.mapAndFilterDiagnostics)(tsDiagnostics, document, snapshot);
}
/**
