...
use orqa_validation::graph::{ArtifactGraph, ArtifactNode};
...
fn collect_depends_on_from_relationships(node: &ArtifactNode) -> Vec<String> {
    node.references_out
        .iter()
...
mod tests {
    ...
    use super::*;
    use orqa_engine_types::types::project_settings::{StatusAutoRule, StatusDefinition};
    use orqa_validation::graph::{ArtifactGraph, ArtifactNode, ArtifactRef};
