// Artifact logic functions for the OrqaStudio engine.
//
// This module provides the business logic for working with governance artifacts:
...
// All functions operate on types defined in `crate::types::artifact`.
//
// Type definitions (structs/enums) live in `crate::types::artifact`. This module
