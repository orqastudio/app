...
fn check_missing_relationships(
    ...
    if (rel_path.starts_with(".orqa/implementation/") || rel_path.starts_with(".orqa/learning/"))
...
mod tests {
    ...
    fn error_on_missing_frontmatter() {
        ...
        let findings = validate_file(".orqa/implementation/epics/EPIC-001.md", content, None, &[]);
