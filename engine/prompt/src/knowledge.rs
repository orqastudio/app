...
//!
//! This is the engine-side implementation of P3 (Generated, Not Loaded):
//! the prompt pipeline assembles only the knowledge artifacts most relevant to
//! the current agent task, not a wholesale dump of the knowledge directory.

use std::path::Path;

use orqa_search::embedder::{EmbedError, Embedder};

use orqa_engine_types::types::knowledge::KnowledgeMatch;
