// Centralised project configuration loader for the engine-types crate.
//
...
//
// Uses `orqa_validation::settings::ProjectSettings` — the minimal but sufficient
// representation of project settings for path resolution and plugin discovery.
// Access layers that need app-specific fields (e.g. GovernanceCounts, DetectedStack)
// perform their own deserialization into their own extended settings types.

use std::path::Path;

use orqa_validation::settings::ProjectSettings;
