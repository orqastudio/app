...
loadDir(resolve(ROOT, ".orqa/learning/rules"), "rules", "RULE-");
loadDir(resolve(ROOT, ".orqa/learning/decisions"), "decisions", "AD-");
loadDir(resolve(ROOT, ".orqa/learning/lessons"), "lessons", "IMPL-");
loadSkills(resolve(ROOT, ".orqa/learning/skills"));
