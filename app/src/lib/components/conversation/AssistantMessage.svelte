...
<HStack align="start" justify="start">
	...
	<div class="max-w-[85%]">
		<Stack gap={1}>
			...
			<div class="border-border bg-muted/50 rounded-2xl rounded-tl-sm border px-4 py-2.5">
				{#if isActivelyStreaming}
					<!-- streaming-text is a scoped style class; pre is structural for whitespace preservation during streaming -->
					<pre class="streaming-text">{displayContent}<span class="cursor-blink" aria-hidden="true"
						></span></pre>
